window.__require = function e(t, n, r) {
  ...
  AdapterBg: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "fa383mdh7NLAaEBa0q6B5Xl", "AdapterBg");
    "use strict";
  ...
  AdapterScreen: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2bd2a3KIOtMt7vk/KSNsL40", "AdapterScreen");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
  ...
  GameConfig: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "db58cWzRdJDE47QvF7Cen8D", "GameConfig");
    "use strict";
  ...
  Main: [ function(require, module, exports) {
    ...
    var Main = function(_super) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 1:
              ...
              if (1 == GameData_1.default.gameCount) this.openGame(0); else {
                this.openMenu();
                this.preLoadGame();
              }
      ...
      Main.prototype.preLoadGame = function() {
        var deps = GameData_1.default.getGameDependencies();
        deps.map(function(bundleName) {
          return AssetsManger_1.default.instance.preloadBundle(bundleName);
        });
        AssetsManger_1.default.instance.preLoadRes(GameData_1.default.curBundleName, GameData_1.default.curEntryPath, cc.Prefab);
      };
