window.__require = function e(t, n, r) {
  ...
  AnimationEx: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "b5e222AafNBBL9diE7uUXRt", "AnimationEx");
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.AnimationEx = void 0;
    var AnimationEx = function() {
      function AnimationEx() {}
      AnimationEx.MoveAnimation = function(obj, startPos, leavePos, time) {
        void 0 === time && (time = .5);
        return new Promise(function(resolve, reject) {
          obj.stopAllActions();
          obj.setPosition(startPos);
          cc.tween(obj).to(time, {
            position: cc.v3(leavePos.x, leavePos.y, 0)
          }).call(function() {
            resolve(null);
          }).start();
        });
      };
      AnimationEx.PlayErrorAnimation = function(obj, initPos) {
        return new Promise(function(resolve, reject) {
          obj.stopAllActions();
          cc.tween(obj).by(.1 / 3, {
      ...
      AnimationEx.playTipAnimation = function(obj) {
        return new Promise(function(resolve, reject) {
          obj.stopAllActions();
          cc.tween(obj).repeat(2, cc.tween().to(.05, {
            scale: 1.1
          }).to(.1, {
            scale: .9
          }).to(.05, {
      ...
      AnimationEx.playSpine = function(spNode, spName, loop) {
  ...
  DragComponent: [ function(require, module, exports) {
    ...
    var DragComponent = function(_super) {
      ...
      DragComponent.prototype.onEnd = function(e) {
        ...
        handler && handler.call(tempCmpt, null);
      };
  ...
  GameCompBase: [ function(require, module, exports) {
    ...
    var GameCompBase = function(_super) {
      ...
      function GameCompBase() {
        ...
        _this.guild_hand = null;
        _this.guild_gravitySensor = null;
        _this.guild_ScheduleHander = null;
        return _this;
      }
      ...
      GameCompBase.prototype.initGravitySensorComponent = function(scale) {
        var _this = this;
        void 0 === scale && (scale = 1);
        return new Promise(function(resolve, reject) {
          AssetsManger_1.default.instance.loadPrefab("gravitySensor/prefab/gravitySensor", "component").then(function(prefab) {
            var GS = cc.instantiate(prefab);
            GS.parent = _this.node;
            GS.active = false;
            GS.scale = scale;
            resolve(GS.getComponent("GravitySensor"));
          });
        });
      };
      ...
      GameCompBase.prototype.guideByTypeShow = function(type, delayTime, startPos, endPos, scale, speed, runTime, waitTime) {
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_f) {
            switch (_f.label) {
             ...
             case 1:
              if (!!this.guild_gravitySensor) return [ 3, 3 ];
              _b = this;
              return [ 4, this.initGravitySensorComponent() ];

             case 2:
              _b.guild_gravitySensor = _f.sent();
              this.guild_gravitySensor.node.active = false;
              _f.label = 3;

             case 3:
              startPos && this.guild_gravitySensor.node.setPosition(startPos);
              this.guild_ScheduleHander = function() {
                _this.guild_gravitySensor.show();
                _this.guild_ScheduleHander = null;
              };
              this.scheduleOnce(this.guild_ScheduleHander, delayTime);
              return [ 3, 13 ];

             case 4:
              if (!!this.guild_hand) return [ 3, 6 ];
              _c = this;
              return [ 4, this.initHandComponent(scale) ];

             case 5:
              _c.guild_hand = _f.sent();
              this.guild_hand.node.active = false;
              _f.label = 6;

             case 6:
              startPos && this.guild_hand.node.setPosition(startPos);
              this.guild_ScheduleHander = function() {
                _this.guild_hand.node.active = true;
                _this.guild_hand.ClickCycle();
                _this.guild_ScheduleHander = null;
              };
              this.scheduleOnce(this.guild_ScheduleHander, delayTime);
              return [ 3, 13 ];
             ...
             case 7:
              if (!!this.guild_hand) return [ 3, 9 ];
              _d = this;
              return [ 4, this.initHandComponent(scale) ];

             case 8:
              _d.guild_hand = _f.sent();
              this.guild_hand.node.active = false;
              _f.label = 9;
             ...
             case 9:
              this.guild_ScheduleHander = function() {
                _this.guild_hand.node.active = true;
                _this.guild_hand.wipeCycle(startPos, endPos, speed);
                _this.guild_ScheduleHander = null;
              };
              this.scheduleOnce(this.guild_ScheduleHander, delayTime);
              return [ 3, 13 ];
             ...
             case 10:
              if (!!this.guild_hand) return [ 3, 12 ];
              _e = this;
              return [ 4, this.initHandComponent(scale) ];

             case 11:
              _e.guild_hand = _f.sent();
              this.guild_hand.node.active = false;
              _f.label = 12;
             ...
             case 12:
              this.guild_ScheduleHander = function() {
                _this.guild_hand.node.active = true;
                _this.guild_hand.TouchCycle(startPos, endPos, waitTime, runTime);
                _this.guild_ScheduleHander = null;
              };
              this.scheduleOnce(this.guild_ScheduleHander, delayTime);
              return [ 3, 13 ];
      ...
      GameCompBase.prototype.guideHide = function(type) {
        if (this.guild_ScheduleHander) {
          this.unschedule(this.guild_ScheduleHander);
          this.guild_ScheduleHander = null;
        }
        if ("number" === typeof type) 0 === type ? this.guild_gravitySensor && (this.guild_gravitySensor.node.active = false) : this.guild_hand && (this.guild_hand.node.active = false); else {
          this.guild_gravitySensor && (this.guild_gravitySensor.node.active = false);
          this.guild_hand && (this.guild_hand.node.active = false);
        }
      };
      ...
      GameCompBase.prototype.record = function(data) {
        ListenerManager_1.ListenerManager.dispatch(BaseEvent_1.BaseEvent.EVENT_FOLLOW_UP, {
          text: data.text,
          textString: data.colorTextString || data.text,
          word: data.showImgBg || false,
          img: data.showImg,
          imgScale: data.imgScale || 1,
          music: data.soundsUrl,
          time: data.recodeTime || 3
        });
      };
  ...
  GravitySensor: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "1b799N8tsNJ9o/DPl50Qdyp", "GravitySensor");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var GravitySensor = function(_super) {
      __extends(GravitySensor, _super);
      function GravitySensor() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      GravitySensor.prototype.show = function() {
        this.node.active = true;
        cc.log("---show-");
      };
      GravitySensor.prototype.hide = function() {
        this.node.active = false;
      };
      GravitySensor = __decorate([ ccclass ], GravitySensor);
      return GravitySensor;
    }(cc.Component);
    exports.default = GravitySensor;
    cc._RF.pop();
  }, {} ],
  ...
  MathEx: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e1d20hozEtMf47BtQu77nKw", "MathEx");
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var MathEx = function() {
      function MathEx() {}
      MathEx.Collision = function(x1, w1, x2, w2) {
        return !(x1.x + w1.width < x2.x || x1.y + w1.height < x2.y || x2.x + w2.width < x1.x || x2.y + w2.height < x1.y);
      };
      ...
      MathEx.limit = function(from, end) {
        from = Math.min(from, end);
        end = Math.max(from, end);
        var range = end - from;
        return from + Math.random() * range;
      };
      MathEx.prototype.randomArray = function(arr) {
      ...
      SpineUtils.playSpineAsync = function(sp, info) {
        return new Promise(function(resolve, reject) {
          if (info.loop) {
            ...
            sp.setCompleteListener(function(_entry) {
              resolve(true);
            });
          }
        });
  ...
  WordTool: [ function(require, module, exports) {
    ...
    var WordTool = function(_super) {
      ...
      WordTool.prototype.showWordAni = function(wordStr, targetPos, callback, delayTime) {
        var _this = this;
        void 0 === targetPos && (targetPos = cc.v2(0, -100));
        void 0 === callback && (callback = null);
        void 0 === delayTime && (delayTime = 2.4);
        this.node.active = true;
  ...
  followUp: [ function(require, module, exports) {
    ...
    var FollowUp = function(_super) {
      ...
      FollowUp.prototype.followUpInit = function(text, textString, word, img, imgScale, music, time) {
        return __awaiter(this, void 0, void 0, function() {
          var designSize, bundleName, showNode;
          var _this = this;
          return __generator(this, function(_a) {
            this.node.active = true;
            ...
            if ("string" === typeof img) {
              ...
              this.imgNode.getComponent(cc.Sprite).spriteFrame = null;
              showNode = cc.instantiate(img);
              showNode.setPosition(0, 0);
              this.imgNode.addChild(showNode);
            }
...
}, {}, [ "CommonEffects", "DragComponent", "coinBoard", "feedBackCtr", "RepeatAfterMeAudio", "followUp", "recordAin", "GravitySensor", "HandCtr", "AnimationEx", "GameCompBase", "MathEx", "Point", "SpineUtils", "Util", "TransferMain", "VoiceTools", "WordTool" ]);